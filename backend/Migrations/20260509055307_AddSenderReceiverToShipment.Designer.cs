...
namespace ShippingAPI.Migrations
{
    ...
    [Migration("20260509055307_AddSenderReceiverToShipment")]
    partial class AddSenderReceiverToShipment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShippingAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "$2a$11$D/OBftFZMKjrQlsfASPQvefVQVg9nHqrbLBys3HmWQEXfqRDcH5g.",
                            Role = 3,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            FullName = "สมชาย ใจดี",
                            IsActive = true,
                            PasswordHash = "$2a$11$Mo4m1yiwGX.lNX21g8AfGuSxp33F580RAj0HIMJL7kJbHs201p37q",
                            Role = 0,
                            Username = "driver01"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "$2a$11$XGcJ4Tjz4QkeeBJrVQxEgelYC6F3S9aFUMjchaW44JsykFq/yeyeG",
                            Role = 1,
                            Username = "manager01"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "$2a$11$WQ4UJMXM7BKbnckssH5G6ucPkJKVh4RztfqkEYtCfX3N67VuIAOIe",
                            Role = 2,
                            Username = "finance01"
                        });
                });
            ...
            modelBuilder.Entity("ShippingAPI.Models.FuelClaim", b =>
                {
                    b.HasOne("ShippingAPI.Models.User", "ApprovedBy")
                        .WithMany("FuelClaims")
