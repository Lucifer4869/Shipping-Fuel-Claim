...
*   **Enhanced Table Visibility:** เพิ่มคอลัมน์เหตุผล (Reason) ในทุกตารางการจัดการรายการ เพื่อให้ Manager และ Finance ตรวจสอบข้อมูลเบื้องต้นได้ทันทีโดยไม่ต้องเปิดดูรายละเอียดทีละรายการ
*   **GPS Distance Reporting:** หน้ารายงานสรุปยอดเปลี่ยนจากการโชว์จำนวนน้ำมันเป็น **ระยะทางจริงจาก GPS (กม.)** เพื่อความโปร่งใสและง่ายต่อการตรวจสอบยอดจ่าย
*   **Approver Accountability:** เพิ่มการแสดงชื่อ **Manager และ เจ้าหน้าที่การเงิน** ที่อนุมัติรายการในรายงาน เพื่อความสมบูรณ์ของเอกสารทางบัญชี
